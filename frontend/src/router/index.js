...
import { getHeaderOffset, isHomeSectionHash, scrollToHomeSection } from '@/utils/scroll'
...
const router = createRouter({
  ...
  scrollBehavior(to, from, savedPosition) {
    ...
    if (to.path === '/' && isHomeSectionHash(to.hash)) {
      return scrollToHomeSection(to.hash).then(() => false)
    }
